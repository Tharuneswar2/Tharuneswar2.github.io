        ...
        >
          ...
          <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
            <iframe
              ...
              title="Tharuneswar Doddi - Introduction"
...
const Hero = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = "/resume/Ken_Patrick_Garcia_Resume.pdf"; // path to your CV
    link.download = "Tharuneswar_Doddi_Resume.pdf";
  ...
  const socialLinks = [
    ...
    {
      href: "https://www.linkedin.com/in/tharuneswar-doddi",
      label: "LinkedIn",
        ...
        <header className="w-full md:w-1/2 flex flex-col justify-center md:order-1">
          <div className="flex flex-col gap-7">
            <div className="hero-text">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                that Deliver <span className="text-blue-500">Results</span>
              </h1>
            </div>

            <p
              className="hero-description text-base sm:text-lg md:text-xl max-w-2xl"
              style={
                theme === "light" ? { color: "#4b5563" } : { color: "#9ca3af" }
              }
            >
              Hi, I'm{" "}
              <span
              ...
              — an AI Full Stack Engineer and Backend & Intelligent Systems
              Architect from India, building complete AI ecosystems that think,
              process, search, evaluate, and scale.
            </p>
            ...
            <div className="pt-4 md:pt-6 border-t border-white/10">
              <div className="flex flex-wrap gap-4 md:gap-6">
                {[
                  {
                    text: "1st Place - Robo Race 2K23",
                    color: "text-blue-500",
                  },
                  {
                    text: "A+ Internship Performance",
                    color: "text-purple-500",
                  },
                  {
                    text: "n8n Deployed on AWS EC2",
